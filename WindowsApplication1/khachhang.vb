...
Public Class frmkhachhang
    ...
    Private Function themsp() As Boolean
        Dim lenhsql As String = "INSERT INTO KHACHHANG(MaKH, TenKH, DiaChi, SoDT, Email)"
        lenhsql += String.Format("VALUES('{0}','{1}','{2}','{3}','{4}')",
                                 txtmakh.Text, txttenkh.Text, txtdiachi.Text, txtsodt.Text, txtemail.Text)
    ...
    Private Function rong() As Boolean
        Return (String.IsNullOrEmpty(txtmakh.Text) OrElse String.IsNullOrEmpty(txttenkh.Text) OrElse
                String.IsNullOrEmpty(txtdiachi.Text) OrElse String.IsNullOrEmpty(txtsodt.Text) OrElse String.IsNullOrEmpty(txtemail.Text))
    End Function
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btnhienthi.Click
        Dim sqlquery As String = String.Format("select MaKH as 'Mã KH' ,TenKH as 'Tên Khách Hàng', DiaChi as 'Địa chỉ', SoDT as 'SĐT', Email as 'Email' from KHACHHANG")
    ...
    Private Sub btnedit_Click(sender As Object, e As EventArgs) Handles btnedit.Click
        Dim conn As SqlConnection = New SqlConnection(chuoiketnoi)
        Dim updatequery As String = "update KHACHHANG set MaKH=@MAKH, TenKH=@TENKH, DiaChi=@DIACHI, SoDT=@SODT, Email=@EMAIL where MaKH=@MAKH"
                    ...
                    Else
                        ...
                        Else
                            ...
                            Else
                                ...
                                addupdate.Parameters.AddWithValue("@SODT", txtemail.Text)
